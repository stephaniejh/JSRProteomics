...
for(cr in crosses) {
    ...
    df_2 <- data.frame(
      ...
      xd = rnorm(n=1:df_1$no_per_cage_2[1],
                 mean = df_1$length[1]/2,
                 sd = df_1$length[1]/7),
      yd = rnorm(n=1:df_1$no_per_cage_2[1],
                 mean = df_1$width[1]/2,
                 sd = df_1$width[1]/7),
      zd = rnorm(n=1:df_1$no_per_cage_2[1],
                 mean = df_1$height[1]/2,
                 sd = df_1$height[1]/7),
    ...
    plot_3D_cloud <- cloud(yd~zd+xd, df_2,
      ...
      zoom = df_2$length[1]/120,
      main = paste0(df_2$s_name[1], " - ", df_2$h_name[1]), 
      scales=list(arrows=TRUE, col=1),
      par.settings = list(axis.line = list(col = "transparent"),
                          axis.text = list(cex = 0.5,
                                           col = "grey20"),
                          par.xlab.text = list(cex = .2, col = "grey20"),
                          par.ylab.text = list(cex = .2, col = "grey20"),
                          par.zlab.text = list(cex = .2, col = "grey20"),
                          par.main.text = list(cex = .7), # main/title
                          plot.symbol = list(cex = 2))
      )
