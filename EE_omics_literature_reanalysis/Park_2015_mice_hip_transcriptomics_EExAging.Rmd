...
# keeps only entries that were TRUE (maybe look into this later)
# also keeps non NAs
lit_review_mRNA_2 <- mRNA_rat_map_comb %>% #1101
  filter(isPresent == TRUE) %>% # 945
  group_by(map_method_df, transcriptomics_id, Reviewed, `Gene name`, Entry,
...
#                 "output/2025_12_17_Park_2015_mRNA_lit_review_EExAging_trimmed_summed_v2.csv",
#                 na = "")
```
