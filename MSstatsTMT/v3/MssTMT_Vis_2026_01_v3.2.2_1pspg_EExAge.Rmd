...
big_volcano <- mapped_comp %>%
  ...
  scale_color_manual(values = c("firebrick", # coloring
                     ...
                     labels = c("\U2191 (adj.p <.05)",
                                ...
                                "\U2191 (adj.p <.1)",
                                "\U2193 (adj.p <.1)")) +
  scale_alpha(range = c(1,.1), guide = "none") + #  GO TRIM VERSION so matches others
  
  geom_text_repel(max.overlaps = 25, size = 2, # gene text on points
                  color = "grey10",
                 segment.size	= 0.3, segment.alpha = 0.5, min.segment.length = 1 ) + 
...
#   geom_text(data = sig_volcano_sum, # up 
#             aes(label = paste0(sig_no_up_lab, " \U2191")),
#             x = 1.75, y = 7.4, size = 3.6, color = "firebrick"
#             ) + 
#   geom_text(data = sig_volcano_sum, # down
#             aes(label = paste0(sig_no_down_lab, " \U2193")),
#             x = -1.75, y = 7.4, size = 3.6, color = "royalblue3"
#             ) + 
# 
# 
#   xlim(-1,1) +
