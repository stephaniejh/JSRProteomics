...
## KEGG Try with ENTREZ ID instead (2026_01_01)
...
for (lb in label_names) {
  ...
  dp <- enrichplot::dotplot(msig_C8_res_working,
                            ...
                            font.size = 11,
                            title = paste0(stringr::str_glue(
                              'Housing x Age - {lb} - msigdbr C8 Cell types 2026_01_04 - via cp_gsea dotplot - 1pspg MSstatsTMT (v3.2.2)'))) 
  ...
  dp_sign <- enrichplot::dotplot(msig_C8_res_working,
                            ...
                            font.size = 11,
                            title = paste0(stringr::str_glue(
                              'Housing x Age - {lb} - msigdbr C8 Cell types 2026_01_04 - via cp_gsea dotplot by sign  - 1pspg MSstatsTMT (v3.2.2)'))) +
    facet_grid(.~.sign)
...
## ReactomePA via ClusterProfiler
...
```{r}
x <- enrichPathway(gene=EEvsSH_genelist_vec,
                   organism = "rat",
                   pvalueCutoff = 0.1,
                   readable=TRUE)
head(x)
...
# --> Expected input gene ID: 310363,81920,117243,25502,361635,57300
# --> return NULL...
```
