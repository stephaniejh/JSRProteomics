...
neuron_map_EE_cell_comp <- drawCell::drawCell(
  ...
  #   "SL0101" = "#E17C05FF", # Endosome
    "SL0197" = "#F2B4B7FF", # Perikaryon / so`ma
  ...
  #   "SL0090" = "#E6AB02FF", # Cytoskeleton
    ...
    "SL0279" = "#EB7F86FF", # axon
  #   "SL0288" = "#97E196FF", # growth cone
    "SL0176" = "#F7945DFF", # Myelin membrane
    "SL0192" = "#672044", # Paranodal septate junction
  ...
  #   "SL0519" = "#EDAD08FF", # presyn active zone
    "SL0529" = "#EDAD08FF", # presynap endocytic zone
    # "SL0259" = "#4C90B4FF", # Synaptic Vesicle
    "SL0260" = "#C70003FF", # Synap Vesic Mem
