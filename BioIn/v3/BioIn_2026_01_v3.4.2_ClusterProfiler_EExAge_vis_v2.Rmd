...
for(kp in kegg_POI) {
  ...
  scale_color_manual(values = c("firebrick", # coloring
     ...
     geom_point(data = my_kp_prot,
                ...
                alpha = .25, size = 1.5, shape = 19, color = "#E09540") + # butterscotch 
...
```{r}
plot_grid(plotlist = kegg_volcano_list[1:6], ncol = 2)

# ggsave("2026_02_23_KEGG_brain_volcanos_4_cowplot_200dpi.png", dpi = 200)
```
