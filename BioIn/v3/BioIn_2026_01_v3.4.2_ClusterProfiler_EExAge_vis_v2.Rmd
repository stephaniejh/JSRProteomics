...
lolliplot <- function(data,
  ...
  # NEED TO SHUFFLE HERE & THERE BUT WORKS
    ...
    background_x = elem_list_rect(fill = c(
      "#AFCC9F", "#cbdec1", "#cbdec1",
      "#BFBBD5", "#D5D3E4", "#D5D3E4")))
...
# ggsave("2026_02_26_KEGG_14_mapped_volcanos_300dpi.png", dpi = 300) # 11.4 x 1.96 in or 11.4 x 13.4

# ggsave("2026_03_09_KEGG_energy_6_map_volcano_300dpi.png", dpi = 300) # 11.2 x 5.92
# ggsave("2026_03_23_KEGG_12_syn_map_volcano_300dpi_top1.png", dpi = 300) # 15.7 x 11.2
```
...
# ggsave("2026_03_31_sig_EEyng_KEGG_intracell_sig_mapped_volcano_330dpi.png", dpi = 330)
```
...
```{r}
# # syanp_ves, neuroa_lig, ret_endoca
...
```{r}
# # EE YNG GABAsyn, neuroacli-Recept, nicotine
plot_grid(kegg_volcano_list$rno04727, kegg_volcano_list$rno04080,
          kegg_volcano_list$rno05033,
          ncol = 1, labels = c("a","b", "c"), label_colour = "grey10", label_size = 12)

# ggsave("2026_03_31_sig_EE_yng_KEGG_synaptic_mapped_volcano_330dpi.png", dpi = 330)
```
